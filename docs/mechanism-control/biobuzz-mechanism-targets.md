# Season mechanism lists do not live here

MIMIC is generic. Per-season / per-robot mechanisms belong in **TeamCode**.

BumbleBee BIOBUZZ (no elevator; intake + color reject, feeder, turret, hood, optional FLOWER tray):
